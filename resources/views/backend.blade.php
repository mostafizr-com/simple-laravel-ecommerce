...
<head>
	...
	<!--[if lt IE 9]>
	  	<script src="{{asset('public/admin/http://html5shim.googlecode.com/svn/trunk/html5.js')}}"></script>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="{{asset('public/admin/img/avatar.jpg')}}" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Dennis Ji
										     </span>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="submenu" href="{{url('/all-products')}}">
						...
						<li>
							<a href="{{url('/social-links')}}">
								...
								<span class="hidden-tablet"> Social Links</span>
							</a>
						</li>

						<li>
							<a href="{{url('/shop-name')}}">
								<i class="icon-font"></i>
								<span class="hidden-tablet"> Shop Name</span>
							</a>
						</li>

						<li>
							<a href="{{url('/delivery-man')}}">
								<i class="icon-picture"></i>
								<span class="hidden-tablet"> Delivery Man</span>
							</a>
						</li>
